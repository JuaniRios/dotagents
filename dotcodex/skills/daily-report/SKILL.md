...
"url", "created_at", "merged_at"}], "issues_closed": [...], "deploys":
[{"repo", "workflow", "env", "head_sha", "conclusion", "created_at",
"title"}]}`.
...
section headers alone — those are data, not voice, and the voice guidance
should not reflow them into sentences.
