---
name: ci
description: "Use when the user asks to run the former Claude /ci workflow: Fast local CI — check, clippy, fmt, nixfmt. Catches most issues in ~3 min. Use /ci-fix for full GitHub CI failures."
---
