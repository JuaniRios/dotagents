...
description: Gather progress on a project (hedge-bot or issuance-bot) from Linear issues, GitHub PRs, and git history since the last run or a custom time range. Outputs an investor-facing summary and saves it to disk.
