...
3. **Assignee** — **default to this user** (`--assignee self`). Offer "me
   (default)" as the first option; only assign someone else if the user picks
   them.
4. **Priority** — number `1`–`4` (1=urgent, 2=high, 3=medium, 4=low). Offer the
   four levels plus a "none" choice.
...
Skip the prompt only when the user has already explicitly specified all of
